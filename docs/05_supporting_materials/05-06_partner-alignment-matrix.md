# OpenForests Partner Alignment Matrix (Teaser Support)
...
| **ReWild** | Storytelling (film/photography) for restoration projects. | We can reference ReWild content inside reports or dashboards so clients get richer narratives alongside compliance outputs. | No analytics, compliance processes, or monitoring governance—purely narrative support. |
