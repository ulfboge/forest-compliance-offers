# Executive Summary – Forest Compliance Assurance Platform

**Audience:** Alexander at OpenForests (and wider partner network)  
**Goal:** Provide a concise, referral-friendly overview that highlights our flexible, customizable service pathway and embedded training offer.
...
**Contact:** Johan Karlsson – johan@kombagis.se | +46 70 123 45 67  
_Supporting materials & sample outputs are stored in `docs/05_supporting_materials/`._
