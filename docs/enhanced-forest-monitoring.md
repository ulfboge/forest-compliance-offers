...
- Carbon project developers monitoring permanence and leakage indicators.
- Certification holders maintaining compliance evidence between audit cycles.
- Impact investors requesting ongoing ESG KPI tracking for financed assets.

---

## Connection to the Integrated Assurance Platform

- **Builds on EUDR Core:** Uses traceability boundaries and risk layers as the baseline for alert monitoring.
...
**Disclaimer:** Monitoring accuracy depends on data availability, weather, and regulatory permissions for drone operations.
